...
- [ ] El calendario muestra **`objective_days × 2` sesiones** distribuidas en **`objective_days` días**
- [ ] Cada día tiene **2 sesiones** (mañana y noche)
- [ ] Los tópicos de cada sesión **coinciden** con los guardados en la tabla `sessions`
- [ ] El badge de dificultad aparece correctamente (Fácil verde, Medio amarillo, Difícil rojo)
- [ ] Las **fechas reales** se calculan correctamente desde `start_date`
- [ ] El día actual muestra el badge **"HOY"** (si aplica)
- [ ] La **cuenta regresiva** muestra el número correcto de días restantes
- [ ] El botón **"Empezar sesión"** solo aparece en la **primera** sesión pendiente
- [ ] El botón **"Empezar sesión"** navega a `/session?session_id=<id>`
- [ ] El botón **"Generar otro plan"** navega a `/setup`
- [ ] La página es **responsiva**: las tarjetas se adaptan en mobile y desktop
- [ ] No hay **errores de consola** (especialmente hydration mismatch warnings)
- [ ] La barra de progreso muestra **0/`sessions.length` completadas** al inicio
