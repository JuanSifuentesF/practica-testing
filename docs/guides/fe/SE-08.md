...
- [ ] Score Hero visible con colores correctos
- [ ] Tópicos fallidos listados
- [ ] Detalle de preguntas expandible con explicaciones
- [ ] Patrones de error con badges
- [ ] Botones de navegación funcionales
- [ ] `alert()` eliminado — ya no aparece
