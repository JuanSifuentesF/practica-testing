...
> **Estado:** implementada y validada (12/07/2026). Addendum UX de rehidratacion aplicado en bug-lab.  
...
El siguiente milestone secuencial del roadmap es **AI-01 — Schema: preferencias IA + tracking de uso/tokens**. AI-01 pertenece a base de datos, por lo que debe generarse y validarse con el flujo DB antes de solicitar AI-02 al skill frontend.
