...
- [ ] En desktop: header con logo, navegación y avatar visible
- [ ] En mobile (375px): hamburguesa visible, Sheet abre desde la izquierda
- [ ] Dropdown del avatar funciona con nombre, email y logout
- [ ] Logout redirige a `/login` correctamente
- [ ] Loading spinner se muestra durante transiciones lentas
- [ ] Tarjetas se adaptan responsivamente (1 columna → 2 → 3)
