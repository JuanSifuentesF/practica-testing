...
> **Addendum correctivo vigente (20/07/2026):** `QuizCard` nunca conserva answer
> keys. Consume la proyección pública durable, espera `Retry-After` ante un
> claim concurrente y rehidrata evaluación/adaptación en replay. Cualquier
> snippet que tipa `correct` en el estado cliente previo al envío es histórico.
