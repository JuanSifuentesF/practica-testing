...
> **Siguiente guía:** PR-01 — GitHub Actions: CI/CD frontend → Vercel  
...
El siguiente bloque del roadmap es **PR-01 — GitHub Actions: CI/CD frontend → Vercel**. Ahí comenzarás a automatizar el despliegue continuo del frontend a producción.
