...
> **Addendum de integridad verificado (19/07/2026):** el diseño original usaba
> FKs simples y permitía combinar el `user_id` de un tenant con el padre de otro.
> La migración forward-only
> `20260719193643_enforce_core_ownership_integrity.sql` reemplaza las cuatro
> relaciones core por FKs compuestas de ownership, conserva sus acciones
> `ON DELETE` y está aplicada en Local/Remote. El baseline pedagógico inferior se
> conserva como historia; el contrato vigente es el addendum.
