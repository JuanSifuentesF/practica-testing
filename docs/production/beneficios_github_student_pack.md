...
|---|---|---|---|
| Alta | DigitalOcean | Usar para FastAPI | Ya está alineado con el backend y los créditos cubren producción inicial. |
...
| Baja | Heroku / Azure / MongoDB / Clerk / Appwrite | No usar en MVP | Duplican decisiones ya tomadas: DigitalOcean, Supabase y Vercel. |

## Inventario General

### ☁️ Nube e Infraestructura
* **DigitalOcean:** $200 en créditos para la plataforma durante 1 año.
* **Heroku:** $13 USD en créditos mensuales durante 24 meses.
* **Microsoft Azure:** $100 en créditos y acceso gratuito a más de 25 servicios en la nube.
