...
**Versión:** 1.0 (baseline histórico)  
**Fecha:** Mayo 2026  
**Autor:** Juan Sifuentes Fernandez  
**Estado:** Snapshot histórico; no representa el estado actual del producto.

> **Fuente de verdad vigente:** `docs/roadmap/ISTQB_Guias_Implementacion.md`
> v2.13. Este documento conserva arquitectura y costos iniciales, incluyendo el
> despliegue DigitalOcean ya realizado. El destino futuro elegido para FastAPI
> es Heroku, pendiente de auditoría; no usar las instrucciones de hosting,
> costos ni fases de este baseline para desplegar.
